...
say_hello_default_arg("shravani")
say_hello_default_arg()
say_hello_default_arg(name="mayuri")  # positional argument
#
#
...
def sum_of_two_number(num1, num2):
     return num1 + num2
result = sum_of_two_number(34, 34)
print(result)
...
result = sum_of_two_number_with_default(20,20)
print(result)